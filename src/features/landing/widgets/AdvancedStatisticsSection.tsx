...
export function AdvancedStatisticsSection() {
  return (
    <section className="@container relative -mt-4 flex w-full flex-col gap-14">
      <div className="flex flex-col gap-6">
        <h2 className="text-preset-3 @3xl:text-preset-2 text-center text-gray-900">
          Advanced Statistics
        </h2>
        <p className="text-preset-7-medium @3xl:text-preset-6-medium text-center text-gray-500">
